            ...
            <ScrollView
                ...
                <View style={styles.headerContainer}>
                    <View style={styles.topHeaderContainer}>
                        <View>
                            <Text style={styles.nameText}>Hrishita Gupta</Text>
                            <Text style={styles.usernameText}>hrishita.invincibleQ</Text>
                            <Text style={styles.friendsText}>20 friends</Text>
                        </View>
                        <View>
